...
export type AnamisesFormFieldSet = {
  firstname?: string;
  lastname?: string;
  address?: string;
  mainMedicalDisorder?: string;
  ...
  return (
    <Form method="post">
      ...
      <fieldset>
        ...
        <div className="flex flex-row justify-end gap-2 mb-4">
          <label htmlFor="mainMedicalDisorder">Hauptbeschwerde:</label>
          <input
            className="border-2 boder-solid border-white"
            aria-required
            type="text"
            name="mainMedicalDisorder"
            id="mainMedicalDisorder"
            placeholder={formFieldValueSet?.mainMedicalDisorder}
          />
        </div>
        <div className="flex flex-row justify-end gap-2 mb-4">
          <span>
        ...
        <div className="flex flex-row justify-end gap-2 mb-4">
          <label htmlFor="furtherMedicalDisorder">Weitere Beschwerden:</label>
          <input
            className="border-2 boder-solid border-white"
            type="text"
            name="furtherMedicalDisorder"
            id="furtherMedicalDisorder"
          />
        </div>
      </fieldset>
      <div className="flex flex-row justify-end gap-2 mb-4">
