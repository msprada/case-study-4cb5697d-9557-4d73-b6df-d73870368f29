      ...
      {!tempLink ? (
          ...
          <Form method="post">
            ...
            <fieldset>
              <div className="flex flex-row gap-2 mb-4">
                ...
                <input
                  className="border-2 boder-solid"
                  aria-required
                  type="text"
                  name="email"
                  id="email"
        ...
        <>
          <div className="flex flex-col mb-4">
            <h1>Anmeldung</h1>
            <p>
              Es wurde soeben eine E-Mail and die E-Mailadresse {email} versendet. Bitte prüfen Sie
              den Posteingang.
            </p>
          </div>
          <p className="text-lg text-yellow-900">
            DEBUG:Following Link can be used to access the anamnesis document:{' '}
            <a href={tempLink}>Login</a>
          </p>
        </>
      )}
    </div>
